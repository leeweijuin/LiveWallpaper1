...
public class DragonflyGradientBackground extends GradientBackground {
    ...
    final private int FOREST_GREEN = Color.argb(255, 32, 95, 74);
    final private int ASH_GREEN_COLOR = Color.argb(255, 136, 185, 144);
   ...
   */
    public int[] getCurrentGradientColor(int hourOfDay, int minOfDay) {
        ...
        else if (hourOfDay <= 18) noonEvening(hourOfDay, minOfDay);
//        else if (hourOfDay <= 21) eveningNight(hourOfDay, minOfDay);
    ...
    public void dawnMorning(int hourOfDay, int minOfDay) {
        ...
        top = calibrateColor(LIGHT_TURQUOSE, ASH_GREEN_COLOR , top, timeFactor, hourOfDay, minOfDay);
    ...
    public void morningNoon(int hourOfDay, int minOfDay) {
        ...
        top = calibrateColor(ASH_GREEN_COLOR , CREAM_COLOR, top, timeFactor, hourOfDay, minOfDay);
    ...
    public void noonEvening(int hourOfDay, int minOfDay) {
        ...
        top = calibrateColor(CREAM_COLOR, ASH_GREEN_COLOR, top, timeFactor, hourOfDay, minOfDay);
        base = calibrateColor(LIGHT_TURQUOSE, TURQUIOSE, base,timeFactor, hourOfDay, minOfDay);
    }
    ...
    /*public void eveningNight(int hourOfDay, int minOfDay) {
        ...
        top = calibrateColor(ASH_GREEN_COLOR, LIGHT_TURQUOSE, top, timeFactor, hourOfDay, minOfDay);
        base = calibrateColor(TURQUIOSE,TURQUIOSE, base, timeFactor, hourOfDay, minOfDay);
    }
*/
    ...
    public void nightMidnight(int hourOfDay, int minOfDay) {
        ...
        top = calibrateColor(ASH_GREEN_COLOR, LIGHT_TURQUOSE, top, timeFactor, hourOfDay, minOfDay);
        base = calibrateColor(TURQUIOSE, BLUE_COLOR, base, timeFactor, hourOfDay, minOfDay);
    }
